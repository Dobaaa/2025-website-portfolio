...
export const gridItems = [
  ...
  {
    id: 6,
    title: "Do you want copy my Gmail ?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const projects = [
  ...
  {
    id: 2,
    title: "3s System [React JS] (workspace management system )",
...
export const workExperience = [
  {
    ...
    desc: "I worked on serval large React JS system and , also worked on integrating backend APIs and creating a responsive web apps.",
  ...
  },
  {
    ...
    desc: "Developed and maintained modern, responsive web applications using React.js and other front-end & backend  technologies. Focused on creating clean, scalable code and delivering exceptional user experiences across various browsers and devices.",
  ...
  },
  {
    ...
    desc: "Working with a different clients from different countries and cultures in freelancer.com andUpwork.com , So I made more than type of project.",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
  {
...
export const socialMedia = [
  ...
  },
  {
    id: 3,
    img: "/link.svg",
    link: "https://www.linkedin.com/in/ahmed-jamal-3a509b220/",
  },
];
